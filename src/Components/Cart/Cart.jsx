...
const Cart = ({ activePanel, handleClosePanel, cart,removeItem,quantityIncrement,quantityDecrement,subTotal,orderTotal,shippingFee,setOrderSummary }) => {
  return (
    <div
      className={`flex flex-col justify-between gap-5 bg-zinc-100 fixed z-40 top-0 right-0 bottom-0 left-auto w-[400px] border-l border-zinc-300 py-7 transform   transition-transform duration-300
    ...
    >
      ...
      {/* cart Item */}
      <div className="flex-1 flex flex-col overflow-y-auto gap-2 scroll">
        {cart.length === 0 ?( <p className="text-zinc-800 text-center ">Your cart is empaty</p>) :
            (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between">
                  <div>
                    {product.onSale && (
                      <span className="text-zinc-600 font-semibold text-lg mr-5 line-through ">
